...
from gomobiletheme.irceline import MessageFactory as _
...
class Logo(base.Logo):
    ...
    def getLogoPath(self):
        ...
        return "++resource++gomobiletheme.irceline/logo.png"
...
class AdditionalHead(base.AdditionalHead):
    ...
    def update(self):
        ...
        self.resource_url = self.portal_url + "/" + "++resource++gomobiletheme.irceline"
