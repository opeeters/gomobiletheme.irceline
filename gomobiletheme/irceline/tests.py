...
__author__ = "Olav Peeters <peeters@irceline.be>"
...
def setup_zcml():
    ...
    import gomobiletheme.irceline
    zcml.load_config('configure.zcml', gomobiletheme.irceline)
    ...
    ztc.installPackage('gomobiletheme.irceline')


# The order here is important.
setup_zcml()
ptc.setupPloneSite(products=['gomobile.mobile', "gomobiletheme.irceline"])
